...
public class JavaSmsApi {
	...
	public String sendSms(Sms sms) throws IOException, URISyntaxException {
		...
		String text = "【优异云音乐】您的验证码是"+smsCode;
		// 发短信调用示例
		...
		String tpl_value = URLEncoder.encode("#code#", ENCODING) + "=" + URLEncoder.encode(smsCode, ENCODING) + "&"
	 ...
	 * 
	 * 
	 * 		public static String bindCall(String apikey, String from, String
	 *         to, Integer duration) { Map < String, String > params = new
	 *         HashMap < String, String > (); params.put("apikey", apikey);
	 *         params.put("from", from); params.put("to", to);
	 *         params.put("duration", String.valueOf(duration)); return
	 *         post(URI_SEND_BIND, params); }
	 * 
	 * 
	 *         通过接口解绑绑定主被叫号码
	 * @param apikey
	 ...
	 * @return
	 * 
	 * 		public static String unbindCall(String apikey, String from,
	 *         String to) { Map < String, String > params = new HashMap <
	 *         String, String > (); params.put("apikey", apikey);
	 *         params.put("from", from); params.put("to", to); return
	 *         post(URI_SEND_UNBIND, params); }
	 */
